 ...
 *   - `renderText` / `renderSarif` / `renderHtml` / `renderReview` / `renderReviewJson` — built-in reporters
...
export { renderHtml, escapeHtml, type HtmlReporterOptions } from './reporter/html.js';
